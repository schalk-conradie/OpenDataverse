    ...
    rows: [
      {
        ...
        description: "Customer reporting and account administration for regional offices",
        emailaddress1: "accounts@example.com",
        telephone1: "+27 21 555 0101",
        statecode: 0,
      ...
      },
      {
        ...
        description: "Distribution and service enquiries for corporate customers",
        emailaddress1: "service@example.com",
        telephone1: "+27 21 555 0102",
        statecode: 0,
        createdon: "2026-06-10T10:30:00Z",
      },
    ],
    columns: ["name", "accountnumber", "accountid", "description", "emailaddress1", "telephone1", "statecode", "createdon"],
    entitySetName: "accounts",
