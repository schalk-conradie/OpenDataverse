...
export const changelogEntries: ChangelogEntry[] = [
  {
    ...
    changes: [
      "Added a three-screen Form Logic Copilot wizard where the first screen selects the entity/form, prompt, AI provider, and model before generating the script.",
      ...
      "Added Save and Publish for generated form scripts, including web resource creation, form event handler binding, and browser-preview fallback behavior.",
      ...
      "Changed Form Logic Copilot web resource naming to use the selected solution publisher prefix and made the script-step publish CTA a navigation action.",
      "Changed Form Logic Copilot publishing to add the table and form to the selected unmanaged solution before applying generated handlers.",
      "Changed Form Logic Copilot publishing to skip selected field handlers when the field control is not on the selected form XML instead of failing the publish.",
